...
const Hero = () => {
  ...
  return (
    <div
      id="Hero"
      className="hero-container row p-2 display-1 ps-lg-5 gap-4 container-fluid m-0 d-sm-grid d-md-grid d-lg-flex"
    >
      <div className="hidden hero-left col p-lg-5 my-lg-2 text-center text-lg-start p-sm-5 m-sm-">
        <span className="hero-left-text">
          Hello!,<span className="wave">👋 </span> I'm Ojo Oluwasola
        </span>
        <br />
        ...
        <h6 className="hero-left-text3">
          ...
          <i className="fa fa-html5"></i> CSS3 <i className="fa fa-css3"> </i>
          and Javascript(React.js) <i className="bi bi-filetype-jsx"> </i> ||
        ...
        <a
          href="#"
          target="_blank"
          className="hidden btn text-light hire-me-btn"
        >
          Hire Me
        </a>
      ...
      <div className="hero-right col p-lg-5 my-lg-2 d-flex justify-content-center align-items-">
        <div className="carousel__container hidden">
          <div className="carousel-item shadow">
            <img className="carousel-item__img" src={Shola} alt="Shollyimg" />
